This Project Folder is used in lieu of the Packer Automated Install, incase it is not yet functioning.

This is intended to be run on an Ubuntu 18.04 or later Virtual Machine, turning it into a Kiosk.
...
2) Install the system and make sure you can access to the internet
